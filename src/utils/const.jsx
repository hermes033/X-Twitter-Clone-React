    ...
    icon: {
      active: (
        <svg viewBox="0 0 24 24" aria-hidden="true" >
          <g>
            <g clipPath="url(#76-clip0_3304_259)">
              <path fill="#fff" clipRule="evenodd" d="M4 0C1.79 0 0 1.79 0 4v16c0 2.21 1.79 4 4 4h16c2.21 0 4-1.79 4-4V4c0-2.21-1.79-4-4-4H4zm5.982 11.941L16.58 2.55h3.82l-8.509 12.109-1.91-2.718zm-6.678-2.71l8.587 12.219h3.816L7.121 9.23H3.304zm3.813 6.786L3.3 21.45h3.819l1.908-2.715-1.91-2.718zm10.155-7.656V21.45H20.4V3.909L17.272 8.36z" fillRule="evenodd">
              </path></g>
            <defs><clipPath id="76-clip0_3304_259">
      ...
      passive: (
        <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
          <path fill="#e7e9ea" d="M2.205 7.423L11.745 21h4.241L6.446 7.423H2.204zm4.237 7.541L2.2 21h4.243l2.12-3.017-2.121-3.02zM16.957 0L9.624 10.435l2.122 3.02L21.2 0h-4.243zm.767 6.456V21H21.2V1.51l-3.476 4.946z"></path>
        </svg>
      )
    }
  },
