...
function Menu() {
  return (
    <nav className="mt-0.5">
      ...
      <NavLink to='/grok' className="py-1 block group">
        {({ isActive }) => (
          <div className={classNames("p-3 rounded-full inline-flex transition-colors items-start gap-5 group-hover:bg-[#eff3f41a]", {
            'font-bold': isActive
          })}>
            {isActive && (
              <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                <g>
                  <path fill="#e7e9ea" d="M6 2h12c2.21 0 4 1.79 4 4v12c0 2.21-1.79 4-4 4H6c-2.21 0-4-1.79-4-4V6c0-2.21 1.79-4 4-4zm.643 15.8l8.109-11.58h2.515L9.158 17.8H6.643z"></path>
                </g>
              </svg>
            )}
            {!isActive && (
