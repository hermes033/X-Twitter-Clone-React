...
import { Carousel } from "react-responsive-carousel"; // Slider için harici bir kütüphane
                ...
                <div className="w-[518.4px] h-full flex flex-col pl-2">
                  ...
                  <div className="w-full h-[20px] flex">
                    ...
                    <div className="w-[18.75px] h-full ml-auto -mt-1.5">
                      ...
                      <div className="w-[34.75px] h-[34.75px] rounded-full flex items-center justify-center hover:bg-[#0a171f]">
                        <svg viewBox="0 0 24 24" width={20} height={20}>
                          <g>
                            <path fill="#61656a" d="M3 12c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2zm9 2c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm7 0c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z">
                            </path>
                          </g>
                        </svg>
                      </div>
                      ...
                      {post.photo || post.video ? (
                        post.photo && post.video ? (
                          <Carousel showThumbs={false} >
                            {post.photo && (
                              <div className="w-[516.8px] h-[516.8px] rounded-2xl border-red-400">
                                <img
                                  src={post.photo}
                                  alt="Post Media"
