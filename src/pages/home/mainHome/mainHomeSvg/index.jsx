  ...
  return (
    <div className="w-full h-[32px] mt-4" >
      ...
      <div className="w-full h-[20px] flex leading-[20px]">
        ...
        <div className="w-[113.23px] h-full">
          <button className="w-[54.56px] h-full flex items-center group">
            <div className="w-[34.75px] h-[34.75px] rounded-full flex items-center justify-center group-hover:bg-[#00b6791e] hover:text-[#00b679]">
              <svg viewBox="0 0 24 24" width={18.75} height={18.75}><path fill="#71767b" className="group-hover:fill-[#00b679]" d="M4.5 3.88l4.432 4.14-1.364 1.46L5.5 7.55V16c0 1.1.896 2 2 2H13v2H7.5c-2.209 0-4-1.79-4-4V7.55L1.432 9.48.068 8.02 4.5 3.88zM16.5 6H11V4h5.5c2.209 0 4 1.79 4 4v8.45l2.068-1.93 1.364 1.46-4.432 4.14-4.432-4.14 1.364-1.46 2.068 1.93V8c0-1.1-.896-2-2-2z"></path></svg>
            </div>
        ...
        <div className="w-[113.23px] h-full">
          <button className="w-[51.05px] h-full flex items-center group transition-colors duration-100">
        ...
        <div className="w-[113.23px] h-full transition-colors duration-100">
          <button className="w-[51.45px] h-full flex items-center group transition-colors duration-100">
            <div className="w-[34.75px] h-[34.75px]  rounded-full flex items-center justify-center transition-colors duration-100 group-hover:bg-[#1c9aee21] hover:text-[#1c9aee] group-hover:text-[#1c9aee]">
              <svg viewBox="0 0 24 24" width={18.75} height={18.75}><path fill="#71767b" className="transition-colors duration-100 group-hover:fill-[#1c9aee]" d="M8.75 21V3h2v18h-2zM18 21V8.5h2V21h-2zM4 21l.004-10h2L6 21H4zm9.248 0v-7h2v7h-2z"></path></svg>
            </div>
        ...
        <div className="w-[18.75px] h-full ml-3 transition-colors duration-100">
          <button className="w-[34.75px] h-full flex items-center group transition-colors duration-100">
            <div className="w-[34.75px] h-[34.75px] flex hover:bg-[#1c9aee2e] rounded-full items-center justify-center transition-colors duration-100">
              <svg viewBox="0 0 24 24" width={18.75} height={18.75}><path fill="#71767b" className="transition-colors duration-100 group-hover:fill-[#1c9aee]" d="M4 4.5C4 3.12 5.119 2 6.5 2h11C18.881 2 20 3.12 20 4.5v18.44l-8-5.71-8 5.71V4.5zM6.5 4c-.276 0-.5.22-.5.5v14.56l6-4.29 6 4.29V4.5c0-.28-.224-.5-.5-.5h-11z"></path></svg>
            </div>
          </button>
        </div>
        ...
        <div className="w-[18.75px] h-full ml-3 transition-colors duration-100">
          <button className="w-[34.75px] h-full flex items-center group transition-colors duration-100">
            <div className="w-[34.75px] h-[34.75px] hover:bg-[#1c9aee2e] rounded-full flex items-center justify-center transition-colors duration-100">
              <svg viewBox="0 0 24 24" width={18.75} height={18.75}><path fill="#71767b" className="group-hover:fill-[#1c9aee] transition-colors duration-100" d="M12 2.59l5.7 5.7-1.41 1.42L13 6.41V16h-2V6.41l-3.3 3.3-1.41-1.42L12 2.59zM21 15l-.02 3.51c0 1.38-1.12 2.49-2.5 2.49H5.5C4.11 21 3 19.88 3 18.5V15h2v3.5c0 .28.22.5.5.5h12.98c.28 0 .5-.22.5-.5L19 15h2z"></path></svg>
            </div>
          </button>
        </div>
